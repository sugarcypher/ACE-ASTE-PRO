...
Every push to `main` deploys live to acepaste.xyz in ~18 seconds via `.github/workflows/deploy.yml`. There is no staging — reverting a change requires another commit.
